        ...
        <section className="hero" aria-labelledby="hero-title">
            <div className="container">
                <div className="hero-stack">
                    ...
                    <p className="lead">I plan, design, and build lean, resilient frontends: clear interfaces, durable
                        component architecture, and measurable acquisition loops.</p>
                    ...
                    <p className="lead small">Available for selective build, refactor, or retained execution
                        support.</p>
