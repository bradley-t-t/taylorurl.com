        ...
        <header className="hero" role="banner" data-reveal data-reveal-from="left">
            <div className="container hero-inner" data-reveal data-reveal-delay="60">
                <div className="hero-text">
                    <h1 className="hero-title" data-reveal data-reveal-delay="120">Websites and Apps Built For Your <span className="accent">Business</span>
                    </h1>
                    <p className="lead" data-reveal data-reveal-delay="180">I build fast, maintainable, accessible websites and JavaScript applications.
